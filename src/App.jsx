...
function App() {
  const photo1 = getCloudinaryUrl('static/profile_pic', { width: 800 });
  const photo2 = getCloudinaryUrl('static/featured_metro', { width: 1200 });
  const photo3 = getCloudinaryUrl('static/carousel_1', { width: 1200 });
  const photo4 = getCloudinaryUrl('static/carousel_2', { width: 1200 });
  const photo5 = getCloudinaryUrl('static/carousel_3', { width: 1200 });
